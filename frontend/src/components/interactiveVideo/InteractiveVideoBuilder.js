        ...
        <Box display="flex" flexDirection='row' justifyContent="center" alignItems="center" height="80vh" maxHeight='100%'>
            ...
            <Box ml={2} flex={1} width={'30%'}>
                ...
                <Grid container direction="column" alignItems="center" spacing={2}>
                    ...
                    <Grid item>
                        <Button variant="contained" color="primary" onClick={onHorizontal} sx={{ minWidth: '170px' }}>
                            Horizontal View
                        </Button>
                    </Grid>
                    <Grid item>
                        <Button variant="contained" color="primary" onClick={onVertical} sx={{ minWidth: '170px' }}>
                            Vertical View
                        </Button>
                    </Grid>
                    <Grid item>
                        <Button variant="contained" color="primary" onClick={handleAddChild} sx={{ minWidth: '170px' }}>
                            Add Child
                        </Button>
                    </Grid>
                    <Grid item>
                        <Button variant="contained" color="primary" onClick={onSubmit} disabled={uploadDisabled} sx={{ minWidth: '170px' }}>
                            Upload Video
                        </Button>
                    </Grid>
                </Grid>
